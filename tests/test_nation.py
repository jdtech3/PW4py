...
#     assert nation_instance.color == "aqua" or nation_instance.color == "beige" or nation_instance.color == "gray"
#     assert nation_instance.colour == "aqua" or nation_instance.colour == "beige" or nation_instance.color == "gray"
